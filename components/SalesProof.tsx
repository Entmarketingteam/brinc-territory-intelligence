...
const stats = [
  { value: "$6M+", label: "Total Creator Revenue" },
...
const translation = [
  ...
  },
  {
    ...
    ent: "$6M+ in tax-verified creator revenue across 3 entities. 2025 alone: ~$2M (ENT Agency $636K + Entenmann Enterprise $934K + FWTFL $412K). ENT Agency doubled YoY: $299K → $636K (+113%). Peak year: FWTFL hit $1.06M in 2022. Entenmann Enterprise 2024: $799K.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            $6M+ in documented creator revenue. 132 brand partners. One creator.
          </p>
          <p className="text-text-secondary max-w-2xl mb-4">
            As co-founder of ENT Agency, I built and managed a full-stack revenue operation across 3 legal entities — tax-verified P&amp;Ls across ENT Agency, Entenmann Enterprise, and FWTFL. $6.45M verified across 6 years. ENT Agency doubled revenue YoY ($299K → $636K). 2025 combined: ~$2M across all entities. $4.5M+ in Amazon GMV driven. 132 brand partners. 4+ years of renewals. Different vertical. Identical sales discipline.
          </p>
        </motion.div>
